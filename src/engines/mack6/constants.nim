...
for rank in 0'u64 .. 7'u64:
    for file in 0'u64 .. 7'u64:
        ...
        if top_left != 0:
            PAWN_ATTACK_MOVES[true][square].add(top_left)
        if top_right != 0:
            PAWN_ATTACK_MOVES[true][square].add(top_right)

        PAWN_ATTACK_MOVES[false][square] = @[]
        if bottom_left != 0:
            PAWN_ATTACK_MOVES[false][square].add(bottom_left)
        if bottom_right != 0:
            PAWN_ATTACK_MOVES[false][square].add(bottom_right)
