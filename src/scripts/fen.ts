...
const squareForHumanNotation: Record<string, Bitboard> = {
  ...
  a7: [0x8000_0000, 0x0000_0000],
  b7: [0x4000_0000, 0x0000_0000],
  c7: [0x2000_0000, 0x0000_0000],
  d7: [0x1000_0000, 0x0000_0000],
  e7: [0x0800_0000, 0x0000_0000],
  f7: [0x0400_0000, 0x0000_0000],
  g7: [0x0200_0000, 0x0000_0000],
  h7: [0x0100_0000, 0x0000_0000],
  a6: [0x0080_0000, 0x0000_0000],
  b6: [0x0040_0000, 0x0000_0000],
  c6: [0x0020_0000, 0x0000_0000],
  d6: [0x0010_0000, 0x0000_0000],
  e6: [0x0008_0000, 0x0000_0000],
  f6: [0x0004_0000, 0x0000_0000],
  g6: [0x0002_0000, 0x0000_0000],
  h6: [0x0001_0000, 0x0000_0000],
  a5: [0x0000_8000, 0x0000_0000],
  b5: [0x0000_4000, 0x0000_0000],
  c5: [0x0000_2000, 0x0000_0000],
  d5: [0x0000_1000, 0x0000_0000],
  e5: [0x0000_0800, 0x0000_0000],
  f5: [0x0000_0400, 0x0000_0000],
  g5: [0x0000_0200, 0x0000_0000],
  h5: [0x0000_0100, 0x0000_0000],
  a4: [0x0000_0080, 0x0000_0000],
  b4: [0x0000_0040, 0x0000_0000],
  c4: [0x0000_0020, 0x0000_0000],
  d4: [0x0000_0010, 0x0000_0000],
  e4: [0x0000_0008, 0x0000_0000],
  f4: [0x0000_0004, 0x0000_0000],
  g4: [0x0000_0002, 0x0000_0000],
  h4: [0x0000_0001, 0x0000_0000],
  a3: [0x0000_0000, 0x8000_0000],
  b3: [0x0000_0000, 0x4000_0000],
  c3: [0x0000_0000, 0x2000_0000],
  d3: [0x0000_0000, 0x1000_0000],
  e3: [0x0000_0000, 0x0800_0000],
  f3: [0x0000_0000, 0x0400_0000],
  g3: [0x0000_0000, 0x0200_0000],
  h3: [0x0000_0000, 0x0100_0000],
